...
public class MainClass {
 ...
 @Test(dependsOnMethods = "loadUrl()")
    ...
    public void VerifyPageTitle() throws IOException {
        ...
        WebElement PageLogo = driver.findElement(By.xpath(properties.getProperty("PageLogo")));
   ...
   @Test(priority = 3)
    public void SearchProduct() throws IOException {
        ...
        driver.findElement(By.xpath(properties.getProperty("SearchButton"))).click();
        WebElement Footwear = driver.findElement(By.xpath(properties.getProperty("FootwearTitle")));
        ...
        driver.findElement(By.xpath(properties.getProperty("FirstProduct"))).click();
    ...
    public String validatingTheProduct() throws IOException{
        ...
        WebElement productName = driver.findElement(By.xpath(properties.getProperty("ProductName")));
        System.out.println(productName.getText());
        String productname = productName.getText();
        WebElement productprice = driver.findElement(By.xpath(properties.getProperty("ProductPrice")));
        ...
        WebElement AgeisVisible = driver.findElement(By.xpath(properties.getProperty("AgeVisible")));
    ...
    public void CartPageValidation(){
        ...
        WebElement productnameincart = driver.findElement(By.xpath(properties.getProperty("CartProductName")));
